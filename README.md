...
| `PAYLOAD_SECRET`         | obrigatória | assina os tokens de sessão do admin. **Mínimo 32 caracteres**, aleatório e **distinto por ambiente** — o arranque recusa mais curto                                                                                                                      |
...
| `PREVIEW_SECRET`         | opcional    | assina os links de pré-visualização. **Não viaja no URL**: o que viaja é um token de uma hora preso ao caminho da página. Sem ela o Live Preview fica desligado, com erro no log; presente, tem o mesmo mínimo de 32 caracteres                          |
