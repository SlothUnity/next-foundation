...
const envExample: Record<SetupProvider, string> = {
  payload: [
    ...
    '',
    '# URL público, sem barra final. O Payload valida com ele a origem dos',
    '# pedidos ao admin e usa-o como targetOrigin do Live Preview, onde a',
    '# comparação é de string exacta. Sem ele a aplicação não arranca.',
    '# Vai para o browser (prefixo NEXT_PUBLIC_) — nunca lá ponhas segredos.',
    'NEXT_PUBLIC_SERVER_URL=http://localhost:3000',
    '',
    '# --- Opcionais ---',
