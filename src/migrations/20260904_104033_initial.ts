...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."_locales" AS ENUM('pt-PT', 'en-GB');
  CREATE TYPE "public"."enum_users_roles" AS ENUM('admin', 'editor');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_published_locale" AS ENUM('pt-PT', 'en-GB');
  CREATE TYPE "public"."enum_redirects_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_site_enabled_locales" AS ENUM('pt-PT', 'en-GB');
  ...
  CREATE TABLE "_pages_v" (
  	...
  	"version_is404" boolean DEFAULT false,
  ...
  CREATE TABLE "redirects" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"type" "enum_redirects_type" DEFAULT 'reference',
  ...
  CREATE TABLE "site_enabled_locales" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum_site_enabled_locales",
  	"id" serial PRIMARY KEY NOT NULL
  );
  ...
  CREATE TABLE "navigation_blocks_hero" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "navigation_blocks_hero_locales" (
  ...
  CREATE TABLE "footer_blocks_hero_locales" (
  	"title" varchar NOT NULL,
  	"subtitle" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  ALTER TABLE "redirects" ADD CONSTRAINT "redirects_reference_id_pages_id_fk" FOREIGN KEY ("reference_id") REFERENCES "public"."pages"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "site_enabled_locales" ADD CONSTRAINT "site_enabled_locales_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."site"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "navigation_blocks_hero" ADD CONSTRAINT "navigation_blocks_hero_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "navigation_blocks_hero" ADD CONSTRAINT "navigation_blocks_hero_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."navigation"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "navigation_blocks_hero_locales" ADD CONSTRAINT "navigation_blocks_hero_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."navigation_blocks_hero"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "footer_blocks_hero" ADD CONSTRAINT "footer_blocks_hero_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "footer_blocks_hero_locales" ADD CONSTRAINT "footer_blocks_hero_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer_blocks_hero"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "redirects_reference_idx" ON "redirects" USING btree ("reference_id");
  CREATE INDEX "redirects_updated_at_idx" ON "redirects" USING btree ("updated_at");
  CREATE INDEX "redirects_created_at_idx" ON "redirects" USING btree ("created_at");
  CREATE INDEX "redirects_from_idx" ON "redirects_locales" USING btree ("from","_locale");
  ...
  CREATE INDEX "site_enabled_locales_order_idx" ON "site_enabled_locales" USING btree ("order");
  CREATE INDEX "site_enabled_locales_parent_idx" ON "site_enabled_locales" USING btree ("parent_id");
  CREATE INDEX "navigation_blocks_hero_order_idx" ON "navigation_blocks_hero" USING btree ("_order");
  CREATE INDEX "navigation_blocks_hero_parent_id_idx" ON "navigation_blocks_hero" USING btree ("_parent_id");
  CREATE INDEX "navigation_blocks_hero_path_idx" ON "navigation_blocks_hero" USING btree ("_path");
  CREATE INDEX "navigation_blocks_hero_image_idx" ON "navigation_blocks_hero" USING btree ("image_id");
  CREATE UNIQUE INDEX "navigation_blocks_hero_locales_locale_parent_id_unique" ON "navigation_blocks_hero_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX "footer_blocks_hero_image_idx" ON "footer_blocks_hero" USING btree ("image_id");
  CREATE UNIQUE INDEX "footer_blocks_hero_locales_locale_parent_id_unique" ON "footer_blocks_hero_locales" USING btree ("_locale","_parent_id");`);
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "site_enabled_locales" CASCADE;
  DROP TABLE "site" CASCADE;
  DROP TABLE "navigation_blocks_hero" CASCADE;
  DROP TABLE "navigation_blocks_hero_locales" CASCADE;
  DROP TABLE "navigation" CASCADE;
  DROP TABLE "footer_blocks_hero" CASCADE;
  DROP TABLE "footer_blocks_hero_locales" CASCADE;
  ...
  DROP TYPE "public"."enum_site_enabled_locales";`);
}
